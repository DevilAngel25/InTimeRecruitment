...
namespace InTimeRecruitment.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        //
        // GET: /Account/RegisterAsCandidate
        [AllowAnonymous]
        public ActionResult RegisterAsCandidate()
        {
            return View();
        }

        //
        // POST: /Account/RegisterAsCandidate
        [HttpPost]
        [AllowAnonymous]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> RegisterAsCandidate(RegisterCandidateViewModel model, HttpPostedFileBase upload)
        {
            if (ModelState.IsValid)
            {
                ...
                if (upload != null && upload.ContentLength > 0)
                {
                    ...
                    user.AvatarImages = new List<AvatarImage> { avatar };
                }
        ...
        //
        // GET: /Account/RegisterAsClient
        [AllowAnonymous]
        public ActionResult RegisterAsClient()
        {
            return View();
        }

        //
        // POST: /Account/RegisterAsClient
        [HttpPost]
        [AllowAnonymous]
        [ValidateAntiForgeryToken]
